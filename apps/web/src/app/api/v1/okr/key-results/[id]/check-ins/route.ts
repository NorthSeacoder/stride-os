...
import { getOkrActivityContext, parseCheckInInput, requireId, requireOkrApiUser } from '../../../_lib';
...
export async function POST(request: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  ...
  try {
    const checkIn = await createKrCheckIn(input, { activityContext: getOkrActivityContext(user) });
