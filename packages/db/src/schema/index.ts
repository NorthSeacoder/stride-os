...
export const taskLists = activeSchema.taskLists;
export const taskListsRelations = activeSchema.taskListsRelations;
export const taskDefinitions = activeSchema.taskDefinitions;
export const taskDefinitionsRelations = activeSchema.taskDefinitionsRelations;
...
export const taskDefinitionKrLinks = activeSchema.taskDefinitionKrLinks;
export const taskDefinitionKrLinksRelations = activeSchema.taskDefinitionKrLinksRelations;
